...
<p><a href="index.php"><img src="img/logo.png" align="left" width="200px" height="120px"></a><img src="img/admin.png" align="center" width="450px" height="120px"></p>
</td>
</tr>
<!--End Of Header-->
<!--Main menus-->
...
?>
 ...
 <?php
  if(isset($_POST['update']))
  {
				...
				{
  $update = mysqli_query("update users set FNAME='$fname',mNAME='$mname', lname='$lname',level='$level', phone_no='$phone_no' 
