...
<br>
 ...
 <table align="center" style="border-radius:5px;border:1px solid #336699;box-shadow:1px 1px 10px black;" height="100px" width="800px">
  <tr>

<tr>
<th bgcolor='green'><font color='white'>Full Name</th>
<th bgcolor='green'><font color='white'>Email</th>
  <th bgcolor='green'><font color='white'>Client Type</th>
...
<th bgcolor='green'><font color='white'>Reservation Payment Receipt</th>
  <th bgcolor='green'><font color='white'>Action</th>


</tr>
<?php
$sql="SELECT user_id, fullname, email, client_type, month, day, year,receipt
            FROM reservpayment;";
...
while($row =$result-> fetch_assoc())
 ...
 echo ("<td> <a href='upload/" . $row['receipt']. "'download>". $row['receipt']."</a></td>");
   ...
   <td>
    <form action="delete_reservpay.php" method="POST">
