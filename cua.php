...
<p><a href="index.php"><img src="img/logo.png" align="left" width="200px" height="120px"></a><img src="img/admin.png" align="center" width="490px" height="120px"></p>
</td>
</tr>
<!--End Of Header-->
<!--Main menus-->
  ...
  <table width="426px" align="center">
	...
	<td><font color="red">*</font>&nbsp;<font size="1">required.</font></td>
		 ...
		 <tr>
		   ...
		   <td><input type="text" name="phone" id="phone" value="09" onKeyPress="return isNumberKey(event)" required x-moz-errormessage="Enter Your Phone Number" ></td>
	     </tr>
              <tr>
              ...
              <td style="padding-top:12px;"><select name="actype" required maxlength="5">
                  ...
                  <option value='3'>Occupant</option>
                </select></td>
              </tr>
			           <tr>
